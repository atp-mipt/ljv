...
John Hamer, Ivan Ponomarev, Nuras Nogayev, Ilya Selivanov
...
| image::nogaev.jpg[Нурас,200,200]
| Нурас Ногаев:
- Студент МФТИ
|===
...
Hamer, J..
“Visualising Java Data Structures as Graphs.” ACE (2004). /поправить/
...
[.notes]
--
1) Код теперь выглядит правильнее и удобнее 2) АПИ был старым и неудобным
--
