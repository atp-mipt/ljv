...
[cols="20a,80a"]
|===
.^| image::ponomarev.jpg[Иван,180,180]
.^|
Иван Пономарев:
- Software Engineer at KURS, tutor at MIPT

.^| image::selivanov.png[Илья,180,180]
.^|
Илья Селиванов:
- Студент МФТИ

.^| image::nogaev.png[Нурас,180,180]
.^|
Нурас Ногаев:
- Студент МФТИ
|===
...
--
reflection api
На рисунке визуализирован хэшмап
с огромной коллизией,
и как он смог его переделать в тримап
--
...
3) Теперь каждый может легко получить доступ к инструменту и вносить вклад
4) теперь пакетные менеджеры могут легко скачать инструмент
5) Теперь используем новые фичи графвиза, html like labels. Переписали генерацию
--
...
[.notes]
--
1) Можно изучить строение любого(?) объекта в джаве
2) Благодаря визуальному отображению "внутренностей" кода, студентам будет проще понимать структуры данных
--
